...
RSpec.describe IndicatorActivityCategory, type: :model do
  ...
  describe "#locked?" do
    it "returns true when the category is referenced by suggested indicator activities" do
    ...
    it "returns true when the category is referenced by indicator activities" do
      category = create(:indicator_activity_category)
      create(:indicator_activity, indicator_activity_category: category)
  ...
  describe "#remove!" do
    ...
    it "does not remove category when it is locked by a suggested activity" do
      category = create(:indicator_activity_category)
      create(:suggested_indicator_activity, indicator_activity_category: category)
    ...
    it "does not remove category when it is locked by an indicator activity" do
      category = create(:indicator_activity_category)
      create(:indicator_activity, indicator_activity_category: category)
