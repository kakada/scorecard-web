  ...
  def public_vote_form_data(form, scorecard)
    {
      ...
      duplicate_warning_title: t("public_votes.duplicate_submission.title", number: form.duplicate_device_submission_number),
      duplicate_device_repeat_message: t("public_votes.duplicate_submission.device_repeat_message", number: form.duplicate_device_submission_number),
