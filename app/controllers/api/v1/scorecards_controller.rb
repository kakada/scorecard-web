  ...
  module V1
    class ScorecardsController < ApiController
      ...
      def update
        ...
        # Prevent duplicate voting indicators (retry-safe)
        params_to_update = ::Scorecards::NormalizeVotingIndicators.new(@scorecard, scorecard_params).call

        if @scorecard.update(params_to_update)
          ::Scorecards::FinalizeSubmission.new(@scorecard).call if final_submit?
