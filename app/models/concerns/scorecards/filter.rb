...
module Scorecards::Filter
  ...
  included do
    def self.filter(params = {})
      ...
      scope = scope.where(facility_id: params[:facility_ids].split(',')) if params[:facility_ids].present?
      scope = scope.where(local_ngo_id: params[:local_ngo_ids].split(',')) if params[:local_ngo_ids].present?
      scope = scope.where(province_id: params[:province_ids].split(',')) if params[:province_ids].present?
      scope = scope.where(year: params[:years].split(',')) if params[:years].present?
