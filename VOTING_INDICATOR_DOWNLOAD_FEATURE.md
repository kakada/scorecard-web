...
## Overview
This feature allows users to download raw voting indicator data as an Excel file, filtered by scorecard and scorecard batch (with a limit of 50 scorecards per batch), to support visualization and analysis in Excel.
